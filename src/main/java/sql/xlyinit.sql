...
insert  into `bdf2_excel_model_detail`(`ID_`,`EXCEL_COLUMN_`,`EXCEL_MODEL_ID_`,`INTERCEPTOR_`,`NAME_`,`TABLE_COLUMN_`) values ('6576d27e40044bcd:-5c91546:15cafb6099e:-7fff',1,'0001',NULL,'地址',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ffe',2,'0001',NULL,'姓名',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ffd',3,'0001',NULL,'备注',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ffc',1,'0002',NULL,'种类',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ffb',2,'0002',NULL,'品牌',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ffa',3,'0002',NULL,'类别',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff9',4,'0002',NULL,'编号',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff8',5,'0002',NULL,'等级',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff7',6,'0002',NULL,'色号',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff6',7,'0002',NULL,'库存',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff5',8,'0002',NULL,'储位',NULL),('6576d27e40044bcd:-5c91546:15cafb6099e:-7ff4',9,'0002',NULL,'备注',NULL);
...
CREATE TABLE `v_balrecord` (
  `balId` int(10) DEFAULT NULL,
  `ctmId` int(10) DEFAULT NULL,
  `creater` varchar(10) DEFAULT NULL,
  `amount` double DEFAULT NULL,
  `createTime` varchar(30) DEFAULT NULL,
  `optType` varchar(10) DEFAULT NULL,
  `remark` varchar(100) DEFAULT NULL,
  `ctmName` varchar(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `v_balrecord` */

/*Table structure for table `v_billrecord` */

DROP TABLE IF EXISTS `v_billrecord`;

CREATE TABLE `v_billrecord` (
  `billNo` int(10) DEFAULT NULL,
  `billNoStr` varchar(7) DEFAULT NULL,
  `billTime` varchar(20) DEFAULT NULL,
  `billType` varchar(35) DEFAULT NULL,
  `carNo` varchar(10) DEFAULT NULL,
  `creater` varchar(10) DEFAULT NULL,
  `driverPhone` varchar(12) DEFAULT NULL,
  `freight` int(20) DEFAULT NULL,
  `remark` varchar(35) DEFAULT NULL,
  `bState` smallint(1) DEFAULT NULL,
  ...
  `salesMgrId` int(10) DEFAULT NULL,
  ...
  `patternNo` varchar(10) DEFAULT NULL,
  `brandName` varchar(10) DEFAULT NULL,
  `brandId` int(10) DEFAULT NULL,
  `gradesName` varchar(10) DEFAULT NULL,
  `specId` int(5) DEFAULT NULL,
  `specName` varchar(10) DEFAULT NULL,
  `typeName` varchar(10) DEFAULT NULL,
  `qty` int(2) DEFAULT NULL,
  `qtyCount` bigint(21) DEFAULT NULL,
  `gradesId` int(10) DEFAULT NULL,
  `typeId` int(10) DEFAULT NULL,
  `mgrName` varchar(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `v_billrecord` */

/*Table structure for table `v_billrecord_fake` */

DROP TABLE IF EXISTS `v_billrecord_fake`;

CREATE TABLE `v_billrecord_fake` (
  `billNo` int(10) DEFAULT NULL,
  `billNoStr` varchar(7) DEFAULT NULL,
  `billTime` varchar(20) DEFAULT NULL,
  `billType` varchar(35) DEFAULT NULL,
...
/*Data for the table `v_billrecord_fake` */
